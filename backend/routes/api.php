...
Route::get('getLazyLoadingList/{limit}/{offset}', [VendorController::class, 'getLazyLoadingList']);
Route::get('getsystemprofileorders', [VendorController::class, 'getsystemprofileorders']);
